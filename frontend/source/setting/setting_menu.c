...
static SettingMenu setting_menus[] = {
    SIMPLE_SETTING_MENU(LANG_MENU_MAIN, main_menu_items, sizeof(main_menu_items) / sizeof(SettingMenuItem), NULL, NULL, NULL, NULL),                                                           // 主菜单                                                                                 // 主菜单
    CUSTOM_SETTING_MENU(LANG_MENU_STATE, NULL, 0, &setting_current_path_is_game, Setting_onStateMenuStart, Setting_onStateMenuFinish, NULL, Setting_onStateMenuDraw, Setting_onStateMenuCtrl), // 即时存档
    SIMPLE_SETTING_MENU(LANG_MENU_GRAPHICS, graphics_menu_items, sizeof(graphics_menu_items) / sizeof(SettingMenuItem), NULL, NULL, NULL, Setting_onGraphicsMenuExit),                         // 图形
    SIMPLE_SETTING_MENU(LANG_MENU_CONTROL, control_menu_items, sizeof(control_menu_items) / sizeof(SettingMenuItem), NULL, NULL, NULL, Setting_onControlMenuExit),                             // 控制
    SIMPLE_SETTING_MENU(LANG_MENU_HOTKEY, hotkey_menu_items, sizeof(hotkey_menu_items) / sizeof(SettingMenuItem), NULL, NULL, NULL, Setting_onHotkeyMenuExit),                                 // 热键
    SIMPLE_SETTING_MENU(LANG_MENU_CORE, NULL, 0, &setting_visibility_core_menu, NULL, NULL, Setting_onCoreMenuExit),                                                                           // 核心
    SIMPLE_SETTING_MENU(LANG_MENU_CHEAT, NULL, 0, &setting_visibility_cheat_menu, NULL, NULL, Setting_onCheatMenuExit),                                                                        // 金手指
    SIMPLE_SETTING_MENU(LANG_MENU_MISC, misc_menu_items, sizeof(misc_menu_items) / sizeof(SettingMenuItem), NULL, NULL, NULL, Setting_onMiscMenuExit),                                         // 杂项
    SIMPLE_SETTING_MENU(LANG_MENU_APP, app_menu_items, sizeof(app_menu_items) / sizeof(SettingMenuItem), &setting_visibility_app_menu, NULL, NULL, Setting_onAppMenuExit),                     // 程序
};
