...
int ImageViewUpdate(void *view)
{
    ...
    int layout_wrap_w = imageView->tex_ori_w + params->padding_left + params->padding_right;
    int layout_wrap_h = imageView->tex_ori_h + params->padding_top + params->padding_bottom;
...
int ImageViewDraw(void *view)
{
    ...
    if (imageView->tex)
    {
        int tex_x = layout_x + params->padding_left;
        int tex_y = layout_y + params->padding_top;
        int tex_max_w = layout_w - params->padding_left - params->padding_right;
        int tex_max_h = layout_h - params->padding_top - params->padding_bottom;
